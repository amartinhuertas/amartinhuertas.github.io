...
1. R. Caraballo, C. W. In, **A. F. Martín**, R. Ruiz-Baier. Robust finite element methods and solvers for the Biot--Brinkman equations in vorticity form, 2023. *Numerical Methods for Partial Differential Equations*. In press, 2023. \doi{10.1002/num.230835} --[CODE](https://github.com/amartinhuertas/BiotBrinkmanWithVorticityPaper.jl/)--
